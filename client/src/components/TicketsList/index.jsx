...
const TicketsListStyled = styled("div")({
	flex: 1,
	overflowY: 'scroll',
	// ...theme.scrollbarStyles, // No se incluye aquí ya que el tema no es accesible
	borderTop: '2px solid rgba(0, 0, 0, 0.12)',
});

// const TicketsListHeader = styled('div')({
//   color: 'rgb(67, 83, 105)',
//   zIndex: 2,
...
// const TicketsCount = styled('span')({
//   fontWeight: 'normal',
